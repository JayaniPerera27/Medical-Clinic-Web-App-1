...
const OldPrescriptionsPage = () => {
    ...
    useEffect(() => {
        ...
        const fetchPatientDetails = async () => {
            try {
                const response = await axios.get(`https://medical-clinic-web-app-backend.vercel.app/api/patients/${username}`, {
        ...
        const fetchPrescriptions = async () => {
            try {
                const response = await axios.get(`https://medical-clinic-web-app-backend.vercel.app/api/prescriptions/${username}`, {
                    headers: { Authorization: `Bearer ${token}` },
                });
    ...
    const deletePrescription = async (id) => {
        try {
            await axios.delete(`https://medical-clinic-web-app-backend.vercel.app/api/prescriptions/${id}`, {
